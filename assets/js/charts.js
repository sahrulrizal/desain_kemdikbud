 (function($) {
	...
	var chart = c3.generate({
		...
		data: {
			columns: [
				// each columns data
				['data1', 20.0, 18.9, 18.5, 17.5, 19.4],
				['data2', 18.0, 16.2, 15.7, 15.5, 15.9]
			],
			labels: true,
			type: 'line', // default type of chart
			colors: {
		...
		axis: {
			x: {
				type: 'category',
				// name of each category
				categories: ['Bandung', 'Jepara', 'Yogya', 'DKI', 'Bogor']
			},
		},
		legend: {
			  show: false, //hide legend
	...
	var chart = c3.generate({
		...
		axis: {
			x: {
				type: 'category',
				// name of each category
				categories: ['Bandung', 'Jepara', 'Yogya', 'DKI Jakarta', 'Bogor']
			},
		},
		legend: {
			  show: false, //hide legend
